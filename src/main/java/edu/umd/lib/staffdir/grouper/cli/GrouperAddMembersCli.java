...
/**
 * Command-line application for adding members to a Grouper group.
 *
 * This application uses "subjectId" (equivalent to the "employeeNumber"
 * field in LDAP), to add members to the specified Grouper group.
 */
public class GrouperAddMembersCli {
  public static final Logger log = LoggerFactory.getLogger(GrouperAddMembersCli.class);

  /**
   * Called by the "grouper-add" script (configured in th
  ...
  public static void main(String[] args) {
    try {
      ...
      WsAddMemberResults results = Grouper.addMembers(config, groupName, subjectIds);

      for (WsAddMemberResult result: results.getResults()) {
  ...
  private static Options getOptions() {
    ...
    Option groupNameOption = Option.builder("g")
        ...
        .argName("group name")
        .required()
        .desc("The Grouper group to add members to")
        .build();
    Option subjectIdsOption = Option.builder("s")
        ...
        .required()
        .valueSeparator(',')
        .desc("A comma-separated list of one or more subject ids to add to the group")
        .build();
  ...
  private static void printHelp(Options options) {
    ...
    String header = "Adds one or more members to a Grouper group";
