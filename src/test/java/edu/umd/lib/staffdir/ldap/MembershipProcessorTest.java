...
public class MembershipProcessorTest {
  ...
  public void testMembershipProcessor() {
    ...
    for(MembershipTestCase test : testCases) {
      ...
      assertEquals("Faculty Permanent Status failed for " + test.membersOf, test.facultyPermanentStatus, info.isFacultyPermanentStatus());
    }
  }
  ...
  public void testFacultyPermanentStatus() {
    ...
    memberWithFacultyPermanentStatus.add("Departmental_Groups:Libraries:Staff_Directory:04_DSS:044100_Software_Systems_Development_and_Research");
    
    MembershipTestCase test = create(memberWithFacultyPermanentStatus, "DSS", "Software Systems Development and Research", null, "044100", true);
...
class MembershipTestCase {
  ...
  public static MembershipTestCase create(String memberOf, String division, String department, String unit, String costCenter, boolean facultyPermanentStatus) {
    return new MembershipTestCase(memberOf, division, department, unit, costCenter, facultyPermanentStatus);
  }

  public static MembershipTestCase create(List<String> membersOf, String division, String department, String unit, String costCenter, boolean facultyPermanentStatus) {
    return new MembershipTestCase(membersOf, division, department, unit, costCenter, facultyPermanentStatus);
  }
  
  public MembershipTestCase(List<String> membersOf, String division, String department, String unit, String costCenter, boolean facultyPermanentStatus) {
  ...
  public MembershipTestCase(String memberOf, String division, String department, String unit, String costCenter, boolean facultyPermanentStatus) {
